...
namespace ScriptableObjectArchitecture.Editor
{
    public abstract class BaseGameEventListenerEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty _invertParameter;
        ...
        public override void OnInspectorGUI()
        {
            ...
            _invertParameter = serializedObject.FindProperty("invertParameter");
            if (_invertParameter != null)
            {
                _invertParameter.boolValue = EditorGUILayout.Toggle("Invert Parameter", _invertParameter.boolValue);
            }
